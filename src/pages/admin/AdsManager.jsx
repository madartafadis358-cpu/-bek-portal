  ...
  return (
    <div className="page-wrapper container section">
      <div className="section-title">
        ...
        <p>Promouvez votre activité ou votre événement auprès des citoyens de Bordj El Kiffan. Paiement par Carte Edahabia.</p>
      </div>
      ...
      <div className="card" style={{ maxWidth: 560, margin: '0 auto' }}>
        ...
        <form onSubmit={handlePay}>
          ...
          <button type="submit" className="btn btn-primary" style={{ width: '100%', marginTop: '0.5rem', padding: '1rem', fontSize: '1.05rem' }}>
            Payer par Carte Edahabia — {selectedPlan ? selectedPlan.price : ''} DZD
          </button>
        </form>
      </div>
